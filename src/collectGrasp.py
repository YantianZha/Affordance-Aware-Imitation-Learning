...
def main():
	...
	data_path = 'dataset/data/training/grasp_test/'
	# obj_path = '/home/allen/data/processed_objects/SNC_v4/03797390/'
	obj_path = 'dataset/processed_objects/SNC_v4_mug/'
	...
	# Set up environment
	env = GraspTeleopEnv("/data/datasets/SERL/Fetch/Grasp-v0/F_B_2/good_grasp_20210213_232603/traj_0_grasp_20210213_232603.pickle")
	# env = GraspTeleopEnv()
